      ...
      <template v-slot:mitra="{ mitra }">
        <div class="transform hover:scale-105 w-full max-w-sm mx-auto rounded-md shadow-md overflow-hidden">
          ...
          <div class="px-5 py-3 mt-5">
              ...
              <div class="mt-3">
                <span class="mr-1 rounded-full bg-gray-300 p-1 text-teal-700 text-sm" v-for="tmp in mitra.mapel_unggulan" :key="tmp.id_mapel_unggulan">
                  #{{ tmp.nama_mapel }}
                </span>
              </div>
