<template>
  <div>
    <div class="text-center font-sans mx-auto mt-5">
      <h1 class="text-teal-700">
        ...
        <span class="font-semibold text-4xl xs:text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl">mudah</span>
      </h1>
    </div>
    ...
    <div class="flex flex-wrap -mx-1 overflow-hidden sm:-mx-1 md:-mx-1 lg:-mx-1 xl:-mx-1">
      ...
      <nuxt-link to="/bimpelatih" class="my-1 px-1 w-1/2 overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/4 xl:my-1 xl:px-1 xl:w-1/4">
        <div class="mx-auto bg-white shadow-md p-4 border-2 rounded-lg lg:max-w-full md:w-56 sm:w-48 hover:bg-gray-100 hover:shadow-xl cursor-pointer">
          <img class="w-40 mx-auto" data-src="https://dl.dropboxusercontent.com/s/iba29wmcilffxh2/n-bmp.png?dl=0" alt="" title="" v-lazy-load>
          <h1 class="text-teal-700 text-center">
            <span class="font-bold xs:text-lg sm:text-2xl md:text-2xl lg:text-2xl">BimPelatih</span>
          </h1>
        </div>
      </nuxt-link>
      ...
      <div class="my-1 px-1 w-1/2 overflow-hidden sm:my-1 sm:px-1 sm:w-1/2 md:my-1 md:px-1 md:w-1/2 lg:my-1 lg:px-1 lg:w-1/4 xl:my-1 xl:px-1 xl:w-1/4">
        <div class="mx-auto bg-white shadow-md p-4 border-2 rounded-lg lg:max-w-full md:w-56 sm:w-48 hover:bg-gray-100 hover:shadow-xl cursor-pointer">
          <img class="w-40 mx-auto" data-src="https://dl.dropboxusercontent.com/s/1sgyqehvfc7zlms/n-bmk.png?dl=0" alt="" title="" v-lazy-load>
          <h1 class="text-teal-700 text-center">
            <span class="font-bold xs:text-md sm:text-2xl md:text-2xl lg:text-2xl">BimKonseling</span>
          </h1>
        </div>
      </div>
      ...
      <div class="text-center font-sans mx-auto">
        <h1 class="text-teal-700">
          <span class="font-semibold text-4xl xs:text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl">Bersama</span>
          <span class="font-extrabold text-5xl xs:text-4xl"> bimbim!</span>
        </h1>
      </div>
